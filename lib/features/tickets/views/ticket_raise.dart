...
class _TicketsTabState extends State<TicketsTab>
  ...
  String _selectedStatusFilter =
      'All'; // 'All', 'Open', 'In Progress', 'Resolved'
  ...
  Widget _buildTicketCard(Complaint complaint, ThemeData theme) {
    ...
    final categoryName = complaint.complaintType?.name ?? language.complaint;
            ...
            Container(
              decoration: BoxDecoration(
                border: Border(
                  left: BorderSide(
                    color:
                        Colors.primaries[complaint.id.hashCode %
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${language.createdOn} ${formatDate(complaint.createdAt)}",
                                style: TextStyle(
                                  color: theme.colorScheme.onSurfaceVariant,
                                  fontSize: 11,
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: language.enterUpdatedDescription,
                                ...
                                messenger.showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      success
                                          ? language
                                                .complaintUpdatedSuccessfully
                                          : language.failedToUpdateComplaint,
                                    ),
    ...
    showDialog(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            language.deleteComplaintMessage,
            style: TextStyle(
              color: theme.colorScheme.onSurfaceVariant,
              height: 1.4,
            ),
